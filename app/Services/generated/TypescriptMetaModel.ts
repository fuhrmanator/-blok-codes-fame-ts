...
//
//   const typescriptMetaModel = Convert.toTypescriptMetaModel(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface TypescriptMetaModel {
  FM3: string;
  id: number;
  name: string;
  classes: Class[];
...
export class Convert {
  public static toTypescriptMetaModel(json: string): TypescriptMetaModel[] {
    return cast(JSON.parse(json), a(r("TypescriptMetaModel")));
  }

  public static typescriptMetaModelToJson(
    value: TypescriptMetaModel[]
  ): string {
    return JSON.stringify(uncast(value, a(r("TypescriptMetaModel"))), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Class: o(
    [
      ...
      { json: "abstract", js: "abstract", typ: u(undefined, true) },
      {
        json: "superclass",
        js: "superclass",
        typ: u(undefined, r("Superclass")),
      },
    ],
    false
  ),
  Package: o([{ json: "ref", js: "ref", typ: 0 }], false),
  Property: o(
    [
  ...
  Superclass: o([{ json: "ref", js: "ref", typ: u(r("RefEnum"), 0) }], false),
  ClassFM3: ["FM3.Class", "FM3.Trait"],
  PropertyFM3: ["FM3.Property"],
  RefEnum: ["Boolean", "Number", "Object", "String"],
};
